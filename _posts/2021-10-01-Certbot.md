...
### (1). 概述
以前申请证书,都是由运维去维护,所以,比较好奇,就想自己尝试下申请免费SSL证书.
...
# ********************************************certbot安装*****************************************************
# 5. 安装certbot
[root@erp ~]# sudo snap install --classic certbot
[root@erp ~]# sudo snap install core; sudo snap refresh core

# 6. 创建软链接
[root@erp ~]# sudo ln -s /snap/bin/certbot /usr/bin/certbot
