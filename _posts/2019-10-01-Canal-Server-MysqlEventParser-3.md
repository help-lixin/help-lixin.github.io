...
>  上一章节对MysqlEventParser还留有一些疑问,而且,整个跟踪过程也比较复杂,咱换一种新的思路进行跟踪,很多优秀的开源框架,会针对某个类有相应的测试类.尝试从测试类入手,增加对MysqlEventParser的理解.

### (2). com.alibaba.otter.canal.parse.inbound.mysql.MysqlDumpTest
```
